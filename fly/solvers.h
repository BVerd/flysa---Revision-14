 ...
 *
 * This is the implementation of DCERk32 = delay continuously embedded 
 * Runge-Kutta 3-2.
 */
void SoDe( double *vin, double *vout, double tin, double tout, double stephint, 
...
// compare two doubles (for some unknown reason they're pointers)
int compare( double *x, double *y );

int y_delayed( double ***vd, int n, double *rktimes, double *tau, 
    double *grid, double **vdone, double **deriv1, double **deriv2, 
    double **deriv3, double **deriv4, 
    int gridsize, double accu, SolverInput * si, Input * inp );

void DCERk32( double **vatt, int n, double *tarray, int tpoints, 
    double *darray, int dpoints, double stephint, double accuracy, 
